        ...
        '>
            ...
            <div className='w-1/2 flex flex-col items-start justify-between pl-6 lg:w-full lg:pl-0 lg:pt-6'>
                ...
                <Link href={link} target='_blank' className='hover:underline underline-offset-2'>
                    <h2 className='my-2 w-fu;; text-left text-4xl font-bold dark:text-light sm:text-sm'>{title}</h2>
                </Link>
...
const Project = ({ title, type, img, link, github }) => {
    return (
        ...
        '>
            ...
            md:-right-2 sm:h-[102%] md:w-[101%] xs:rounded-[1.5rem]
            ' />
            ...
            <div className='w-full flex flex-col items-start justify-between mt-4'>
                ...
                <Link href={link} target='_blank' className='hover:underline underline-offset-2'>
                    <h2 className='my-2 w-fu;; text-left text-2xl font-bold lg:text-2xl'>{title}</h2>
                </Link>
